...
# wait for the rf_k1 / rf_k2 pair to finish
...
one rf_block16 ONNXIM_KV_LAYOUT=block ONNXIM_KV_BLOCK=16 &
one rf_block64 ONNXIM_KV_LAYOUT=block ONNXIM_KV_BLOCK=64 &
one rf_head    ONNXIM_KV_LAYOUT=head  ONNXIM_KV_BLOCK=16 &
wait
